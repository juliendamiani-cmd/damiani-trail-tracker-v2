...
function currentSyncPayload(){
  ...
  return {version:32,updatedAt:new Date().toISOString(),raceName:race().name,position:{km:pos.km,source:pos.source,updatedAt:pos.updatedAt||new Date().toISOString()},times:[...times],health:hist.slice(-20),start:race().start,goal:race().goal,trackingUrl:familySettings().tracking};
}
...
function renderMessages(){
  renderMessageList("familyMessagesList",8,false);renderMessageList("runnerMessagesList",30,true);
